...
# 각 vehicle k가 i node에서 c1은 출발 적재량, c2는 도착 적재량
c1 = [[model.add_var(var_type=INTEGER) for i in V] for k in K]
c2 = [[model.add_var(var_type=INTEGER) for i in V] for k in K]
